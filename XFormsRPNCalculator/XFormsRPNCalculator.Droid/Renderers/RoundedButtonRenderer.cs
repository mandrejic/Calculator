...
using XFormsRPNCalculator.Droid.Renderers;

[assembly: ExportRenderer(typeof(RoundedButton), typeof(RoundedButtonRenderer))]

namespace XFormsRPNCalculator.Droid.Renderers
{
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Button> e)
        {
            ...
            if (Control != null)
            {
                ...
                button.SizeChanged += (s, args) =>
                {
                    ...
                    if (button.BackgroundColor.R == -1.0 && button.BackgroundColor.G == -1.0
                        && button.BackgroundColor.B == -1.0)
                    {
